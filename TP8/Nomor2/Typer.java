...
public class Typer extends Thread {
    ...
    public void run(){
        ...
        // Buatlah variable howLongToType yang memuat waktu yang diperlukan typer untuk menulis 1 kata dalam milisecond
        ...
        typeRacer.addResult(new Result(botName, System.currentTimeMillis())); // You need to calculate the correct finish time
    }
}
